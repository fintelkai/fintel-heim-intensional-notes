...
\note{The idea of refining the Stalnakerian model of the context by moving from
  ...
  \cite{hulstijn-1997-issues}). We will later see approaches that give a
  partition semantics to interrogatives. It's important to distinguish the two
  moves. As we'll see in this section, one can have a partition pragmatics
  without a partition semantics.}%
...
We will address the role of the feature [\textsc{wh}] in section ????.
...
\end{minipage}
%
\note{This is the ANSPOSS in \cite{hagstrom-2003-GLOT-questions}'s
  terminology.}%
