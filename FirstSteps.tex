...
it. In \Last, we do not compute the meaning for \expression{in the world of
...
will want to do is to make \LLast be the result of functional application. But
...
\ex. \extitle{Semantic Domains} \a. $D_{e} = D$, the set of all possible
...
functions from $D_{\sigma}$ to $D_{\tau}$. \b. \term{Intensions}: If $\sigma$ is
