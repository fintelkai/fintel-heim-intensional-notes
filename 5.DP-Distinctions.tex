...
\marginnote{That a trace of type $\angles{et,t}$ does not in fact yield the
  targeted non-specific reading had not been noticed until we bothered to
  calculate the meaning of (\lastx). \cite{fox:2000}, which derives from a
  dissertation supervised by us, contains this erroneous claim: }%
