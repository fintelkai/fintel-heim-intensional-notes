...
\marginpar{\centering\includegraphics[height=1in]{Brouwer.jpg}\\
...
that from any $p$-world\marginnote{``$p$-world'' is a very common way of saying
  ``world of which $p$ is true''} we can only access worlds from which, in turn,
